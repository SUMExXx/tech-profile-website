    ...
    <main className="flex flex-col items-center justify-start">
      <section className="flex flex-col w-full background-grid justify-start items-center md:gap-[40px] gap-[25px] bg-custom-gradient md:p-24 px-[20px] py-[30px]">
        <div className="relative flex justify-center items-center">
          ...
          <button className="absolute md:subtitle text-white md:flex hidden justify-center items-center text-center right-[360px] top-[-16px] md:w-[273.41px] md:h-[52.41px]" style={{backgroundImage: "url('/images/leftSkillVector.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat"}}>
            {contents.skill1}
          </button>
          <button className="absolute md:subtitle text-white md:flex hidden justify-center items-center text-center left-[364px] top-[-16px] md:w-[273.41px] md:h-[52.41px]" style={{backgroundImage: "url('/images/rightSkillVector.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat"}}>
            {contents.skill2}
          </button>
          <button className="absolute md:subtitle text-white md:flex hidden justify-center items-center text-center right-[360px] top-[90px] md:w-[273.41px] md:h-[52.41px]" style={{backgroundImage: "url('/images/leftSkillVector.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat"}}>
            {contents.skill3}
          </button>
          <button className="absolute md:subtitle text-white md:flex hidden justify-center items-center text-center left-[364px] top-[90px] md:w-[273.41px] md:h-[52.41px]" style={{backgroundImage: "url('/images/rightSkillVector.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat"}}>
            {contents.skill4}
          </button>
          <button className="absolute md:subtitle text-white md:flex hidden justify-center items-center text-center right-[360px] top-[196px] md:w-[273.41px] md:h-[52.41px]" style={{backgroundImage: "url('/images/leftSkillVector.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat"}}>
            {contents.skill5}
          </button>
          <button className="absolute md:subtitle text-white md:flex hidden justify-center items-center text-center left-[364px] top-[196px] md:w-[273.41px] md:h-[52.41px]" style={{backgroundImage: "url('/images/rightSkillVector.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat"}}>
            {contents.skill6}
          </button>
      ...
      <section className="relative w-full justify-center items-center bg-black overflow-hidden gap-[10px] md:p-[20px] p-[10px] flex flex-col flex-nowrap">
        <div className="flex justify-start items-center w-full gap-[10px] animate-infinite-scroll">
          {
            skills.map((item) => (
              <div key={crypto.randomUUID()} className="py-[10px] px-[16px] rounded-full outline outline-1 -outline-offset-1 outline-violet text text-white flex justify-center items-center">
                {item}
              </div>
            ))
          }
