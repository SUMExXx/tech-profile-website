...
import { contents, projectPreviews, webTechIcons } from "@/data/website";
  ...
  return (
    <section className="flex flex-col w-full justify-start items-center md:gap-[40px] gap-[25px]">
        ...
        <div className="flex flex-col justify-center items-start  md:mb-[40px] mb-[20px] md:gap-[40px] gap-[20px]">
            <div className="w-full justify-center items-center flex flex-wrap md:px-[80px] px-[20px] md:gap-[40px] gap-[20px] md:mt-[80px] text-violet">
            ...
            <div className="w-full justify-center items-center text-center flex md:px-[80px] p-[20px] text-violet">
