...
const sitemap = (): MetadataRoute.Sitemap => {
  return [
    ...
    //blogs
    { url: `${process.env.NEXT_PUBLIC_BASE_URL}/blog/deploy-any-backend-server-to-aws-ecs-with-auto-scaling`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.7 },
  ];
};
