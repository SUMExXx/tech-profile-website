...
export const Blog1Metadata: BlogMetadata = {
  ...
  keywords: ['AWS', 'ECS', 'Elastic Beanstalk', 'ECR', 'Elastic Container Registry', 'Deployment', 'Backend', 'Deployment Guide', 'Auto-scaling', 'Cloud Computing', 'Server Deployment', 'Infrastructure as Code', 'DevOps', 'Containerization', 'Microservices', 'Cloud Services', 'AWS Services', 'Scalable Applications'],
