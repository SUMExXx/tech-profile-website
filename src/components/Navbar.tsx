  ...
  return (
    <nav className='z-50 flex w-full fixed top-0 justify-center md:h-[80px] h-[60px] bg-main-background' id='navbar_container'>
        <div className='flex justify-between items-center max-w-[1440px] md:px-20 px-[10px] w-full'>
            <Link rel="canonical" href={process.env.NEXT_PUBLIC_BASE_URL || '/'} className='flex items-center gap-2 md:gap-4 md:min-w-[300px]'>
            ...
            <div className='flex justify-end items-center gap-[20px] md:min-w-[300px]'>
